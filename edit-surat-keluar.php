...
<body>
    ...
    <section class="container-fluid">
        <div class="container d-flex justify-content-between">
            <div class="display-5 fw-normal">Edit Surat Keluar<div class="h5 fw-normal">Edit Surat <?php echo $data['kepada'] ?> </div></div>
        ...
        <div class="modal-body">
                            <form action="backend/surat-keluar/EditData.php" method="POST">
                            <input name="id" value="<?php echo $data['id_keluar'] ?>"  hidden />
                            <input name="id2" value="<?php echo $_SESSION['username'] ?>"  hidden />
                                <div class="form-group mb-2">
                                    <label for="" class="h6 fw-bold">Keterangan</label>
                                    <input type="text" name="Data1" value="<?php echo $data['keterangan'] ?>" class="form-control"  aria-describedby="helpId">
                                </div>
                                <div class="form-group mb-2">
                                ...
                                <div class="row">
                                    <div class="form-group mb-2 col">
                                        ...
                                        <input type="date" name="Data3"  value="<?php echo $data['tgl_keluar'] ?>" class="form-control" placeholder="" aria-describedby="helpId">
                                    </div>
                                    <div class="form-group mb-2 col">
                                        <label for="" class="h6 fw-bold">Tanggal Dibuat</label>
                                        <input type="date" name="Data4" value="<?php echo $data['tgl_catat'] ?>" class="form-control" placeholder="" aria-describedby="helpId">
                                    </div>
                                </div>
                                <div class="form-group mb-2">
                                    <label for="" class="h6 fw-bold">Ringkasan</label>
                                    <textarea class="form-control" name="Data5"  rows="3"><?php echo $data['ringkasan'] ?></textarea>
                                </div>
                                <div class="form-group mb-2">
