            ...
            <div class="card shadow-lg mb-4">
                ...
                <div class="row">
                        <div class="form-group m-2 col">
                            ...
                            <input type="text" name="Data1" value="<?php echo $data['tujuan'] ?>"  class="form-control" placeholder="" aria-describedby="helpId" readonly>
                        </div>
                            ...
                            <label class="col-md-4 h6" >Sifat Surat</label>
                                <select name="Data2" class="form-control">
                                    <option value="<?php echo $data['level'] ?>" selected ><?php echo $data['level'] ?></option>
                                        <option disabled value="biasa">Biasa</option>
                                        <option disabled value="penting">Penting</option>
                                        <option disabled value="rahasia">Rahasia</option>
                                </select>
                        </div>
                    </div>
                    <div class="form-group mb-2">
                            <label for="" class="h6 fw-bold">Diteruskan Kepada</label>
                            <input type="text" name="Data3" id="no_surat" value="<?php echo $data['kepada'] ?>" class="form-control" placeholder="" aria-describedby="helpId" readonly>
                        </div>
                    <div class="form-group mb-2">
                        <label for="" class="h6 fw-bold">Catatan</label>
                        <input type="text" name="Data4" id="no_surat" value="<?php echo $data['catatan'] ?>" class="form-control" placeholder="" aria-describedby="helpId" readonly>
                    </div>
                    <div class="form-group mb-4">
                        <label for="" class="h6 fw-bold">Isi</label>
                        <textarea class="form-control" name="Data5"  rows="3" readonly><?php echo $data['isi'] ?></textarea>
                    </div>
                    <div class="form-group mb-2">
                    <button type="submit" class="btn btn-primary">Save</button>
                    <a class="btn btn-primary" href="./input-surat-disposisi.php">Back</a>
                    </div>
                    </div>
                </form>
            </div>
